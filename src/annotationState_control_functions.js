...
$.extend(AnnotationStateToolbar.prototype, {
	...
	_inject: function(element) {
		element.innerHTML = 
			...
			'        <button id="circle" type="button" class="btn btn-primary osd_drawctrl">Circle\n' +
			...
			'            <button id="poi" type="button" class="btn btn-primary" style="height:54px">Pin\n' +
			...
			'        <button id="freehand" type="button" class="btn btn-primary" style="height:54px">Freehand</button>\n' +
			'    </div>\n' +
