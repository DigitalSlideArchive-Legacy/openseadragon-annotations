...
$.extend(AnnotationOverlay.prototype, {
	...
	redraw: function() {
		if( this.viewer ) {
			...
			//Added by Mohammed
			//Add the form to the text annotation layer
			/*this.textelement.innerHTML = '<form role="form">' +
			  '<div class="form-group">' +
				'<input type="text" class="form-control" id="email">' +
			  '</div>' +
			  '<button type="submit" class="btn btn-default" id="cancel_annotation_btn">Cancel</button>' +
			  '<button type="submit" class="btn btn-default" id="save_annotation_btn">Save</button>' +
			  '</form>';*/
			this.draw();
		}
	},
